...
**This pass: dump complete.** JSONC rebuild is a follow-up — **no invented geometry**. Hatch 141 blank-doc remains blocked until shell JSONC exists.
...
| Blank-doc JSONC replay | **PENDING** — dump-only this pass |
