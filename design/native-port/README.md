...
- **main_shell dump (complete)**: `main_shell-32.{json,md}` — Extrude1 seed OD160/ID152×210L + 101 extrudes / 13 combines / patterns (329 features). Review AABB **159.9502×210.0000×159.9751** @ (-79.9502, -105.0000, 43.0125) (`shell-first-review/main-shell-assembly-coordinates.stl`). JSONC chapter **PENDING** (no invented geometry). Unblocks hatch MoveCopy5 dependency once JSONC exists.
- **Next**: shell JSONC (`design_v0_1_barrel_shell.nbcad.jsonc`) from this dump; then finish hatch blank-doc replay.
